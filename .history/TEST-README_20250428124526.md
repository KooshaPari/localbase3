...
This script will:
1. Run tests for the frontend
2. Run tests for the API
3. Run tests for the blockchain component (if it exists)
4. Run tests for the provider component (if it exists)
