...
describe("SignUpForm", () => {
	...
	it("validates form inputs", async () => {
		...
		// Mock the first useState call for email
		useStateMock.mockImplementationOnce(() => ["", jest.fn()]);
		// Mock the second useState call for password
		useStateMock.mockImplementationOnce(() => ["", jest.fn()]);
		// Mock the third useState call for confirmPassword
		useStateMock.mockImplementationOnce(() => ["", jest.fn()]);
		// Mock the fourth useState call for fullName
		useStateMock.mockImplementationOnce(() => ["", jest.fn()]);
		// Mock the fifth useState call for error
		useStateMock.mockImplementationOnce(() => [null, setErrorMock]);
		// Mock the sixth useState call for loading
		useStateMock.mockImplementationOnce(() => [false, jest.fn()]);
		// Mock the seventh useState call for successMessage
		...
		// Verify setError was called with the correct message
		expect(setErrorMock).toHaveBeenCalledWith("Please fill in all fields");
