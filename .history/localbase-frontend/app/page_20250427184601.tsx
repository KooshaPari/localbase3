      ...
      <header className="bg-white shadow-md">
        <div className="container flex items-center justify-between px-4 py-6 mx-auto">
          <div className="flex items-center">
            <span className="text-2xl font-bold text-indigo-600">LocalBase</span>
          </div>
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-4 text-xl text-gray-600">
                Access powerful AI models or monetize your GPU resources in a decentralized marketplace.
              </p>
              <div className="flex flex-col mt-8 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                ...
                <Link
                  href="/docs"
                  className="px-8 py-3 text-base font-medium text-indigo-600 bg-white border border-indigo-600 rounded-md hover:bg-indigo-50"
                >
                  Learn More
                </Link>
              </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 gap-8 mt-12 sm:grid-cols-2 lg:grid-cols-3">
            <div className="p-6 bg-indigo-50 rounded-lg">
              ...
              <h3 className="mb-2 text-xl font-semibold text-gray-900">High Performance</h3>
              <p className="text-gray-600">
                Access powerful AI models with low latency and high throughput for your applications.
              </p>
            </div>
            ...
            <div className="p-6 bg-indigo-50 rounded-lg">
              ...
              <h3 className="mb-2 text-xl font-semibold text-gray-900">Decentralized Security</h3>
              <p className="text-gray-600">
                Built on blockchain technology for transparent, secure, and trustless transactions.
              </p>
            </div>
            ...
            <div className="p-6 bg-indigo-50 rounded-lg">
              ...
              <h3 className="mb-2 text-xl font-semibold text-gray-900">Cost Effective</h3>
              <p className="text-gray-600">
            ...
            <div className="p-6 bg-indigo-50 rounded-lg">
              ...
              <h3 className="mb-2 text-xl font-semibold text-gray-900">Provider Verification</h3>
              <p className="text-gray-600">
                All providers are verified and benchmarked to ensure quality and reliability.
              </p>
            </div>
            ...
            <div className="p-6 bg-indigo-50 rounded-lg">
              ...
              <h3 className="mb-2 text-xl font-semibold text-gray-900">Fair Marketplace</h3>
              <p className="text-gray-600">
                Transparent pricing and reputation system ensures a fair marketplace for all participants.
              </p>
            </div>
            ...
            <div className="p-6 bg-indigo-50 rounded-lg">
              ...
              <h3 className="mb-2 text-xl font-semibold text-gray-900">Developer Friendly</h3>
              <p className="text-gray-600">
                Simple API, comprehensive documentation, and SDKs for popular programming languages.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-4 text-xl text-indigo-100">
              Join the decentralized AI revolution today and start using or providing AI compute resources.
            </p>
            <div className="flex flex-col items-center justify-center mt-8 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
              <Link
                href="/signup"
                className="px-8 py-3 text-base font-medium text-indigo-600 bg-white rounded-md hover:bg-indigo-50"
              >
                Sign Up Now
              </Link>
              <Link
                href="/docs"
                className="px-8 py-3 text-base font-medium text-white bg-transparent border border-white rounded-md hover:bg-indigo-700"
              >
                Read the Docs
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <Link href="/docs/tutorials" className="text-gray-400 hover:text-white">
                    Tutorials
                  </Link>
                </li>
              </ul>
